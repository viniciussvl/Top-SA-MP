<div class="col-md-3">
    ...
    <?php } else {
        ...
        <fieldset>
            ...
            <a href="painel/index.php" class="btn btn-primary">Painel de Controle</a>
        </fieldset>
    ...
    <fieldset>
        ...
        <form method="GET" action="busca.php" class="form-inline">
            <div class="form-group">
                <label class="sr-only" for="busca">Email address</label>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="<?= $url; ?>registrar.php" class="btn btn-primary">Registrar</a>
                </div>
            </div>
        </div>
    </div>